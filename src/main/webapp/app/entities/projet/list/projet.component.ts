...
export class ProjetComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProjet): string => this.projetService.getProjetIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.projets = this.refineData(dataFromBody);
  }

  protected refineData(data: IProjet[]): IProjet[] {
