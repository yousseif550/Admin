...
export class SuiviComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISuivi): string => this.suiviService.getSuiviIdentifier(item);
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.suiviService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
